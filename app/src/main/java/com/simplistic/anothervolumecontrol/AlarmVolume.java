...
public class AlarmVolume extends Activity {
    ...
    private void initBar() {
        try
        {
            ...
            voice.setOnSeekBarChangeListener(new OnSeekBarChangeListener()
            {
                ...
                {
                    currentVol = mgr.getStreamVolume(AudioManager.STREAM_ALARM);
                    if(currentVol >= mgr.getStreamMaxVolume(AudioManager.STREAM_ALARM)){
                ...
                {
                    mgr.setStreamVolume(AudioManager.STREAM_ALARM,
                            progress, 0);
