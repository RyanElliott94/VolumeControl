...
public class MusicVolume extends Activity {
    ...
    private void initBar() {
        try
        {
            ...
            voice.setOnSeekBarChangeListener(new OnSeekBarChangeListener()
            {
                ...
                {
                    currentVol = mgr.getStreamVolume(AudioManager.STREAM_MUSIC);
                    if(currentVol >= mgr.getStreamMaxVolume(AudioManager.STREAM_MUSIC)){
