...
public class RingVolume extends Activity {
    ...
    private void initBar() {
        try
        {
            ...
            voice.setOnSeekBarChangeListener(new OnSeekBarChangeListener()
            {
                ...
                {
                    currentVol = mgr.getStreamVolume(AudioManager.STREAM_RING);
                    if(currentVol >= mgr.getStreamMaxVolume(AudioManager.STREAM_RING)){
                ...
                {
                    mgr.setStreamVolume(AudioManager.STREAM_RING,
                            progress, 0);
