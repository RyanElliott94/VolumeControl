...
public class VoiceVolume extends Activity {
    ...
    private void initBar() {
        try
        {
            ...
            voice.setOnSeekBarChangeListener(new OnSeekBarChangeListener()
            {
                ...
                {
                    currentVol = mgr.getStreamVolume(AudioManager.STREAM_VOICE_CALL);
                    if(currentVol >= mgr.getStreamMaxVolume(AudioManager.STREAM_VOICE_CALL)){
                ...
                {
                    mgr.setStreamVolume(AudioManager.STREAM_VOICE_CALL,
                            progress, 0);
